...
Version  : 3.1.2
Release  : 57
URL      : https://github.com/rosmanov/pecl-eio/archive/3.1.2/pecl-eio-3.1.2.tar.gz
Source0  : https://github.com/rosmanov/pecl-eio/archive/3.1.2/pecl-eio-3.1.2.tar.gz
...
%prep
%setup -q -n pecl-eio-3.1.2
cd %{_builddir}/pecl-eio-3.1.2
pushd ..
cp -a pecl-eio-3.1.2 buildavx2
popd
