...
Version  : 3.1.4
Release  : 78
URL      : https://github.com/rosmanov/pecl-eio/archive/3.1.4/pecl-eio-3.1.4.tar.gz
Source0  : https://github.com/rosmanov/pecl-eio/archive/3.1.4/pecl-eio-3.1.4.tar.gz
...
%prep
%setup -q -n pecl-eio-3.1.4
cd %{_builddir}/pecl-eio-3.1.4
pushd ..
cp -a pecl-eio-3.1.4 buildavx2
popd
